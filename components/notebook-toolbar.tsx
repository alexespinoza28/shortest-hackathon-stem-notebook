  ...
  return (
    <div className="w-64 border-r border-border bg-card p-6">
      <div className="mb-6">
        ...
        <p className="text-sm text-muted-foreground">Click to add to your notebook</p>
      </div>
      ...
      <div className="mt-8 p-4 bg-muted rounded-lg">
        <p className="text-xs text-muted-foreground">
          <strong className="text-foreground">Tip:</strong> Drag blocks to reorder them in your notebook
        </p>
      </div>
    </div>
  )
